 ...
 *
 * Parameter are available to modify the script actions
 * - site = siteid to run on, eg 'enwiki'
 * - offset = an offset to start from, eg '100'
 *
...
if( !array_key_exists( 'count', $options ) ){
	...
	$maxoffset = $options['count'] + $offset;
}
