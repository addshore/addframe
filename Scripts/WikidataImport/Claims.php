...
$option['site'] = 'enwiki';
$option['category'] = 'Dead People';
$option['titleRegex'] = null;
$option['wdConditions'] = array('p622' => 'q1234');
$option['onlyIfNotSet'] = true;

$option['property'] = 'p888';
$option['value'] = 'q123';
...
$wiki = $wm->getSiteFromSiteid( $option['site'] );
if( !$wiki instanceof Site ){
	die("No such wiki");
}

$category = $wiki->newCategoryFromTitle( 'Category:'.$option['category'] );
if( !$category instanceof Category ){
	die("No such category");
}

$pages = $category->getCategoryMembers();

/** @var $page Page */
foreach( $pages as $page ){

	//Check agains page regex
