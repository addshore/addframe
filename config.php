...
$config['mitag']['cleanuplink rot'] = new Template('cleanup-link rot',Array('Linkrot','Bare URLs','Link rot','Bare links','Barelinks','Bareurls','Bare urls','Cleanup-linkrot','Bare URL','BareURLs','Bare-URLs','Cleanup link-rot','Cleanup link rot','Bare refs','Bare references','Bareurl','BareURL','Bare','Cleanup-link-rot'),true);
