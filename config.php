...
$config['sandbox']['Wikipedia:Tutoria']['name'] = 'Wikipedia:Tutorial';
$config['sandbox']['Wikipedia:Tutorial']['id'] = 531634619;
$config['sandbox']['Wikipedia:Tutoria/E']['name'] = 'Wikipedia:Tutorial/Editing';
$config['sandbox']['Wikipedia:Tutorial/E']['id'] = 536379216;
$config['sandbox']['Wikipedia:Tutoria/F']['name'] = 'Wikipedia:Tutorial/Formatting';
$config['sandbox']['Wikipedia:Tutorial/F']['id'] = 536271169;
$config['sandbox']['Wikipedia:Tutoria/W']['name'] = 'Wikipedia:Tutorial/Wikipedia links';
$config['sandbox']['Wikipedia:Tutorial/W']['id'] = 536271176;
$config['sandbox']['Wikipedia:Tutoria/C']['name'] = 'Wikipedia:Tutorial/Citing sources';
$config['sandbox']['Wikipedia:Tutorial/C']['id'] = 536246390;
$config['sandbox']['Wikipedia:Tutoria/K']['name'] = 'Wikipedia:Tutorial/Keep in mind';
